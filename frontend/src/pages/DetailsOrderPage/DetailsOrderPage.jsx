...
const DetailsOrderPage = () => {
  ...
  const { data } = useQuery({ queryKey: ['orders-details'], queryFn: fetchDetailsOrder, enabled: !!id })
  ...
  return (
    <div style={{ width: '100%', height: '1000px', background: '#f5f5fa' }}>
      <div style={{ width: '1000px', margin: '0 auto', height: '1000px' }}>
