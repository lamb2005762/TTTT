...
const OrderPage = () => {
    ...
    const priceDiscountMemo = useMemo(() => {
        const result = order?.orderItemsSlected?.reduce((total, cur) => {
            ...
            return priceMemo * 0.01 * totalDiscount
        }, 0)
        if (Number(result)) {
            return result
        }
    ...
    return (
        <div style={{ background: '#f5f5fa', with: '100%', height: '100vh', padding: '0 100px' }}>
                        ...
                        <div style={{ width: '100%' }}>
                            <WrapperInfo>
                                <div>
                                    ...
                                    <span onClick={handleChangeAddress} style={{ color: '#6495ED', cursor: 'pointer' }}>Thay đổi</span>
                                </div>
                            </WrapperInfo>
                            <WrapperInfo>
