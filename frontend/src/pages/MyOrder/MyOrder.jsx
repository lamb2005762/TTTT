  ...
  return (
    <WrapperContainer>
      <div style={{ height: '100%', width: '1270px', margin: '0 auto' }}>
        <h3 style={{ padding: '0 150px' }}>Đơn hàng của tôi</h3>
        <WrapperListOrder>
          {orders?.map((order) => {
            console.log('lam', orders)
            return (
              <WrapperItemOrder key={order?._id}>
                <WrapperStatus>
                  ...
                  <div>
                    ...
                    <span style={{ color: '#6495ED', fontWeight: 'bold' }}>{`${order.isDelivered ? 'Đã giao hàng' : 'Chưa giao hàng'}`}</span>
                  </div>
                  <div>
                    <span style={{ color: 'red' }}>Thanh toán: </span>
                    <span style={{ color: '#6495ED', fontWeight: 'bold' }}>{`${order.isPaid ? 'Đã thanh toán' : 'Chưa thanh toán'}`}</span>
                  </div>
                </WrapperStatus>
                ...
                <WrapperFooterItem>
                  ...
                  <div style={{ display: 'flex', gap: '10px' }}>
                    <ButtonComponent
                      ...
                      styleTextButton={{ color: '#6495ED', fontSize: '14px' }}
                    >
                    </ButtonComponent>
                    <ButtonComponent
