...
import ButttonInputSearch from '../ButtonIconSearch/ButtonIconSearch';
...
const HeaderComponent = () => {
  ...
  return (
    <div style={{ heiht: '100%', width: '100%', display: 'flex', background: '#6495ED', justifyContent: 'center' }}>
      <WrapperHeader style={{ justifyContent: 'space-between' }}>
        <Col span={5}>
          <WrapperTextHeader to='/'>BOOK STORE</WrapperTextHeader>
        </Col>
        <Col span={13}>
          <ButttonInputSearch
            size="large"
